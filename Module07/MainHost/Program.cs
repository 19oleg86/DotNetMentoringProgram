...
namespace MainHost
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //xmlReader.SimpleStreamAxis(pathToResource, "catalog");
            IEnumerable<XElement> result = ReaderFromXml.SimpleStreamAxis(pathToResource, "author");
            ...
            //WriterToXml xmlWriter = new WriterToXml();

            //xmlWriter.WriteToXml(pathForNewXml, book, newspaper, patent);
